    ...
    <div class="login-magic-wrapper">
      ...
      <div class="login-window-wrapper">
        <div class="login-window">
          <h1> :: 로 그 인 :: </h1>
          <form id="loginFrm" name="loginFrm" action="<%= request.getContextPath()%>/login" method="POST">
            <table>
              <tr>
                <td>
              ...
              <tr class="lower-buttons">
                <td>
                  <div class="button-flexbox">
                    ...
                    <button class="button-default" type="button" id="register" onclick="location.href='<%=request.getContextPath()%>/member/enroll'">회원가입</button>
                  </div>
                </td>
              </tr>
            </table>
